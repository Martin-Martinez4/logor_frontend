...
const CheckmarkIcon = () => {
    ...
    return(
        ...
        <div className='flexRowContainer2 fitContent'>
            ...
            <svg onClick={handleAnimateClick} className={animateClass?"pointer svgCheckMarkIcon":"pointer"} width="28" height="27" viewBox="0 0 28 27" fill="none" xmlns="http://www.w3.org/2000/svg">
